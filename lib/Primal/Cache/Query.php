 ...
 * This class is dependent upon the Primal.Database library.  
 * It is included in Primal.Cache as an example of how to use a Cachable instance.
 *
...
class Query extends \Primal\Database\MySQL\Query {
